...
// Le jeu
var vortexPiece, vortexNumero, liVide, coVide, numeroBouton, fini;
...
function ajouterTDbouton(noeud, n) {
	...
	bouton.innerHTML = '<img src="img/btn' + numeroBouton[n] + '.gif">';
...
function clicOuvrirAide() {
	dom_aide.innerHTML = '<button type="button" onclick="clicFermerAide()" class="btnAide">Cacher le mode d\'emploi</button> <fieldset onclick="clicFermerAide()"><legend>Mode d\'emploi</legend><br />Mélangez d\'abord les numéros.<br /><br />Quand le mélange vous semble suffisant, arrêtez !<br /><br />Cliquez sur les boutons pour faire tourner les numéros 4 par 4 <br />... et les remettre ainsi dans le bon ordre ...<br /></fieldset>';
}

//================== clicFermerAide ==================
function clicFermerAide() {
	dom_aide.innerHTML = '<button type="button" onclick="clicOuvrirAide()" class="btnAide">Mode d\'emploi</button>';
}
